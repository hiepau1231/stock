...
urlpatterns = [
    ...
    path('api/market-overview/', views.DashboardView.as_view(http_method_names=['get']), name='market_overview'),
    ...
    # API endpoint cho technical indicators



    path('api/stock/<str:symbol>/indicators/', views.get_technical_indicators, name='technical_indicators'),
